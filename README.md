...
* 1.8MHz, overrides 15/64kHz base clock, full frequency range from C0-C9 when used in combination with ```2CH Linked```.
...
The volume envelope describes how the volume of the instrument changes through time.
